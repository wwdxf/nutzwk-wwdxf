...
public class Generator {
    ...
    public String generateCode(String packageName, String templatePath) throws IOException {
        ...
        log.error("hhh:::packageName="+packageName+"***hhh:::templatePath="+templatePath);
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (Map.Entry<String, TableDescriptor> entry : tables.entrySet()) {
            ...
            log.error("hhhhh:model="+modelPackageName+",service="+servicePackageName+",serviceImpl="+servicePackageName+",controller="+controllerPackageName);
            for (String type : new String[]{"model", "service", "serviceImpl", "controller", "view", "locale"}) {
                ...
                if (type.equals("view")) {
                    ...
                    if ("service".equals(type)) {
                        path = projectPath + "/sms-app/sms-common/src/main/java";
                        packageName = servicePackageName;
                        log.error("hhhhh:servicePackageName="+servicePackageName);
                    }
