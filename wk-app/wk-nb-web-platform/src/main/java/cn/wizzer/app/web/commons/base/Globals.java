...
import cn.wizzer.app.utils.FTPUtils;
...
public class Globals {
    ...
    public static void initFtp(PropertiesProxy conf) {
        Globals.ftpUtils = FTPUtils.getInstance(conf.get("ftp.host"), conf.getInt("ftp.port"), conf.get("ftp.username"), conf.get("ftp.password"));
    }
