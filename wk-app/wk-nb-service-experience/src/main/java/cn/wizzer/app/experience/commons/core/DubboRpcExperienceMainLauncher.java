package cn.wizzer.app.experience.commons.core;

import cn.wizzer.app.experience.commons.ig.RedisIdGenerator;
...
public class DubboRpcExperienceMainLauncher {
    ...
    public void init() {
        ...
        //通过POJO类创建表结构
        try {
            Daos.createTablesInPackage(dao, "cn.wizzer.app.experience", false);
        } catch (Exception e) {
        ...
        try {
            if (log.isDebugEnabled()) {
                //通过POJO类修改表结构
                Daos.migration(dao, "cn.wizzer.app.experience", true, false);
            }
        } catch (Exception e) {
            log.error(e.getMessage(), e);
        }
